...
PKG_DESCS = {
    ...
    "cups-runit":                    {"en":"CUPS for runit-based systems (Artix, Void)","ro":"CUPS pentru sisteme bazate pe runit (Artix, Void)","fr":"CUPS pour les systèmes runit (Artix, Void)","de":"CUPS für runit-basierte Systeme (Artix, Void)","es":"CUPS para sistemas basados en runit (Artix, Void)","it":"CUPS per sistemi runit (Artix, Void)","pt":"CUPS para sistemas runit (Artix, Void)","ru":"CUPS для систем на runit (Artix, Void)","ja":"runitベースシステム用CUPS (Artix, Void)","zh":"runit系统的CUPS (Artix, Void)","ko":"runit 기반 시스템용 CUPS (Artix, Void)","ar":"CUPS لأنظمة runit (Artix, Void)"},
    "cups-openrc":                   {"en":"CUPS for OpenRC-based systems","ro":"CUPS pentru sisteme bazate pe OpenRC","fr":"CUPS pour les systèmes OpenRC","de":"CUPS für OpenRC-basierte Systeme","es":"CUPS para sistemas basados en OpenRC","it":"CUPS per sistemi OpenRC","pt":"CUPS para sistemas OpenRC","ru":"CUPS для систем на OpenRC","ja":"OpenRCベースシステム用CUPS","zh":"OpenRC系统的CUPS","ko":"OpenRC 기반 시스템용 CUPS","ar":"CUPS لأنظمة OpenRC"},

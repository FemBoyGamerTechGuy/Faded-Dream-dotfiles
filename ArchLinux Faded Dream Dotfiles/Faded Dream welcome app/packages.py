...
BROWSERS = [
    {"pkg":"librewolf",                 "exec":"librewolf",             "name":"LibreWolf",
     ...
     "icon":"🦊", "repo":"extra", "aur":False, "recommended":True},
...
GAMING = [
    {"section":"Launchers", "packages":[
        {"pkg":"steam",                     "name":"Steam",
         ...
         "icon":"🎮", "repo":"multilib", "aur":False, "sub":[]},
    ...
    {"section":"Compatibility", "packages":[
        {"pkg":"wine", "name":"Wine", "desc":"Windows compatibility layer",
         "icon":"🍷", "repo":"extra", "aur":False, "sub":[
            {"pkg":"winetricks", "name":"Winetricks", "repo":"extra", "aur":False},
    ...
    {"section":"Performance", "packages":[
        {"pkg":"gamemode", "name":"GameMode", "desc":"CPU/GPU performance optimizer",
         "icon":"⚡", "repo":"extra", "aur":False, "sub":[
            {"pkg":"lib32-gamemode", "name":"GameMode (32-bit)", "repo":"multilib", "aur":False},
        ]},
...
FILE_MANAGERS = [
    {"section":"Graphical File Managers", "packages":[
        ...
        {"pkg":"thunar",        "name":"Thunar",
         ...
         "icon":"📁", "repo":"extra", "aur":False, "sub":[
            {"pkg":"thunar-volman",            "name":"Volume Manager",    "repo":"extra", "aur":False},
            {"pkg":"thunar-archive-plugin",    "name":"Archive Plugin",    "repo":"extra", "aur":False},
            {"pkg":"thunar-media-tags-plugin", "name":"Media Tags Plugin", "repo":"extra", "aur":False},
        ]},
...
PRINTING = [
    {"section": "Printing", "packages": [
        {"pkg": "__cups__", "name": "CUPS",
         ...
         "icon": "🖨️", "repo": "extra", "aur": False, "sub": [
            {"pkg": "cups-pdf",              "name": "CUPS PDF",           "repo": "extra", "aur": False},
            {"pkg": "ghostscript",           "name": "Ghostscript",        "repo": "extra", "aur": False},
            {"pkg": "gsfonts",               "name": "GS Fonts",           "repo": "extra", "aur": False},
            {"pkg": "system-config-printer", "name": "Printer Config GUI", "repo": "extra", "aur": False},
        ]},
